  ...
  <div class="content justify-start">
    <div class="step-panel" style="gap:18px">
      <div class="align-center">
        <div class="step-title">Créer une salle</div>
        <div class="step-sub marge-haut-8">Vous serez l'hôte — les questions arrivent aléatoirement</div>
      </div>
      <div class="cfg-card">
        <div class="cfg-row">
      ...
      <div class="launch-summary">
        ...
        <div class="sum-row">
          ...
          <span class="sum-val" id="summary" style="font-size:13px;font-weight:700">3 manches · max 8 joueurs</span>
        </div>
      </div>
    ...
    window.createRoom = function() {
      ...
      const room = {
        config: {
          ...
          nbQuestions: null,
          manches:     Number(cfg.manches),
          maxPlayers:  Number(cfg.maxPlayers),
