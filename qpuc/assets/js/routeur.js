...
const ECRANS = {
  ...
  'config-paris':            () => import('./ecrans/config-paris.js'),
  'annonce-paris':           () => import('./ecrans/annonce-paris.js'),
  'jeu-paris':               () => import('./ecrans/jeu-paris.js'),
  'classement-paris':        () => import('./ecrans/classement-paris.js'),
  'rejoindre-paris':         () => import('./ecrans/rejoindre-paris.js'),
  'lobby-paris':             () => import('./ecrans/lobby-paris.js'),
  'config-pouvoirs':         () => import('./ecrans/config-pouvoirs.js'),
  'lobby-pouvoirs':          () => import('./ecrans/lobby-pouvoirs.js'),
  'intro-pouvoirs':          () => import('./ecrans/intro-pouvoirs.js'),
  'regles-pouvoirs':         () => import('./ecrans/regles-pouvoirs.js'),
  'jeu-pouvoirs':            () => import('./ecrans/jeu-pouvoirs.js'),
  'classement-pouvoirs':     () => import('./ecrans/classement-pouvoirs.js'),
  ...
  'memo-flash':              () => import('./ecrans/memo-flash.js'),
